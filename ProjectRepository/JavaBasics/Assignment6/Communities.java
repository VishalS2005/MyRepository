public class Communities {
    ...
    double level = data[community][14];
	return level; // replace this line
    }
    ...
    public static double findAverageLifeExpectancy(double[][] data) {
        ...
        double lifeExpentancy = (lifeSum/(data.length));
        return lifeExpentancy; // replace this line
    ...
    public static double highestPopulationWithHealthIssue (double[][] data, char healthIssue) {
        ...
        double maxA = data[0][15];
        double maxD = data[0][16];
        double maxH = data[0][17];
    ...
    public static double largestRacialDemographic(double[][] data, int community) {
        ...
        // WRITE YOUR CODE HERE
        double largestPercentage = data[community][0];

        for (int i = 1; i <= 7; i++) {
            if (largestPercentage < data[community][i]) {
                largestPercentage = data[community][i];
            }
        }

        largestPercentage *= 100;
        return largestPercentage; // replace this line
    }
